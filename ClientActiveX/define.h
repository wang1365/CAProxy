...
enum CertInfoGetType {
	 ...
	 SGD_EXT_PRIVATEKEYUSAGEPERIOD  =	0x00000027,	//私钥有效期
...
enum CertInfoType{
	 ...
	 CERT_DEVICEPROVIDER = 14,	//用户证书介质提供者即csp名称
	 CERT_DEVICEAFFIX =	15,	//用户证书介质附加库
	 CERT_SIGNPATH	  =	16,	//用户签名证书路径
	 CERT_EXCHPATH	  =	17,	//用户加密证书路径
	 CERT_SIGNPFXPATH =	18,	//用户签名P12证书路径
	 CERT_EXCHPFXPATH =	19, //用户加密P12证书路径
	 CERT_UNIQUEIDOID =	22,	//用户证书UniqueID的OID
};
...
enum SGD {
	 ...
	 SGD_SM1_MAC	=	0x00000110,	//SM1算法MAC加密模式
	 ...
	 SGD_SSF33_MAC =	0x00000210,	//SSF33算法MAC加密模式

	/***** 非对称算法标识 *****/
	 SGD_SM2_1 =	0x00020100,	//SM2签名算法
	 SGD_SM2_2 =	0x00020200,	//SM2密钥交换协议
	 SGD_SM2_3 =	0x00020400,	//SM2加密算法
	...
	/***** 签名算法标识 *****/
	SGD_SHA1_RSA   =	0x00001002,	//Sha1RSA算法,
	SGD_SHA256_RSA =	0x00001004,	//Sha256RSA算法, 
	SGD_SM3_RSA    =	0x00001001,	//SM3RSA算法 
	SGD_SM3_SM2    =	0x00020101	//SM3SM2算法
};
