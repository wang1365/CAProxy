...
public:
	...
	STDMETHOD(SOF_Login)(BSTR CertID, BSTR PassWd, int * nRetryCount);
	STDMETHOD(SOF_ChangePassWd)(BSTR CertID, BSTR OldPassWd, BSTR NewPassWd, VARIANT_BOOL * pbResult);
	...
	STDMETHOD(SOF_VerifySignedData)(BSTR Cert, BSTR InData, BSTR SignValue, VARIANT_BOOL* rv);
	STDMETHOD(SOF_SignFile)(BSTR Cert, BSTR InFile, BSTR* rv);
	STDMETHOD(SOF_VerifySignedFile)(BSTR Cert, BSTR InFile, BSTR SignValue, VARIANT_BOOL* rv);
	STDMETHOD(SOF_EncryptData)(BSTR SymmKey, BSTR Indata, BSTR* rv);
	STDMETHOD(SOF_DecryptData)(BSTR SymmKey, BSTR Indata, BSTR* rv);
	STDMETHOD(SOF_EncryptFile)(BSTR SymmKey, BSTR InFile, BSTR OutFile, VARIANT_BOOL* rv);
	STDMETHOD(SOF_DecryptFile)(BSTR SymmKey, BSTR InFile, BSTR OutFile, VARIANT_BOOL* rv);
	...
	STDMETHOD(SOF_VerifySignedDataByP7)(BSTR P7Data, VARIANT_BOOL* rv);
	STDMETHOD(SOF_GetP7SignDataInfo)(BSTR P7Data, LONG type, BSTR* rv);
	STDMETHOD(SOF_SignDataXML)(BSTR CertID, BSTR InData, BSTR* rv);
	STDMETHOD(SOF_VerifySignedDataXML)(BSTR InData, VARIANT_BOOL* rv);
